...
class Pokemon(models.Model):
    ...
    title_en = models.CharField(verbose_name='Название(eng)', max_length=20, blank=True)
    title_jp = models.CharField(verbose_name='Название(japan)', max_length=20, blank=True)
